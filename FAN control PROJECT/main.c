...
//Read the room temperature using an appropriate sensor, then turn on a fan or air conditioner when the temperature exceeds 30o and Display the read temperature on an LCD.
